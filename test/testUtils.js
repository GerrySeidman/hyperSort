...
(function(exports) {
    ...
    var randomPerson = function() {
        ...
        var person = {
            ...
            */
            ...
            toString: function() {
                return this.uid + ': ' + this.last + ' ' + this.first + ' ' + this.__i;
            },
    ...
    exports.peopleMaker = {
        ...
        validate: function(persons, unStableOK, supressStatus) {
            ...
            for (i = 0; i < persons.length; i++) {
                ...
                // console.log(i + '.__i: ' + person.__i);

                if (i !== 0) {
                    if (person.last < prevPerson.last) {
                        valid = false;
                        break;
                    } else if (person.last > prevPerson.last) {
                        if (!supressStatus && (printed < maxToPrint)) {
